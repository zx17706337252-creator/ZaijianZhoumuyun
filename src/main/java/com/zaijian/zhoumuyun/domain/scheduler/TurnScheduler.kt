...
object TurnScheduler {
    ...
    private const val AI_SCHEDULE_MAX_TOKENS = 300  // AI 调度用的 Prompt + 回复 token 上限
    ...
    suspend fun scheduleAuto(
        ...
        else                                     -> scheduleNoMention(ctx, apiCall)
    }
    ...
    private suspend fun scheduleNoMention(
        ...
        return if (ctx.userMessage.length > AI_SCHEDULE_THRESHOLD && apiCall != null) {
