...
data class PregnancyAnswerEntity(
    ...
    /**
     * @Deprecated 方案 5-7：D3 收敛链不再按 pregnancyStartedAt 切割，
     * 三个 DAO 查询方法零调用。recordAnswer() 中已停止写入（改为固定 0L），
     * 后续迭代将删除此字段及相应 DAO 方法。
     */
    @Deprecated("收敛链不再按 pregnancyStartedAt 切割，已停写")
