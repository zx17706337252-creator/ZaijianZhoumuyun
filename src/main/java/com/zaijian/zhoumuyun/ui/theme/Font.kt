...
val SerifSC: FontFamily = FontFamily(
    Font(R.font.noto_serif_sc_bold, weight = FontWeight.Bold),
    Font(R.font.noto_serif_sc_bold, weight = FontWeight.Medium),
)
...
val MonoFamily: FontFamily = FontFamily(
    Font(R.font.mono_regular, weight = FontWeight.Normal),
)
