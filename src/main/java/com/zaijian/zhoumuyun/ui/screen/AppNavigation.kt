...
sealed class AppRoute(val route: String) {
    ...
    /** 待办11：我们的故事时间线 */
    object Timeline : AppRoute("timeline/{characterId}") {
        fun createRoute(characterId: Int? = null) = "timeline/${characterId ?: -1}"
    }
        ...
        NavHost(
            ...
            composable(AppRoute.Tasks.route) {
                TaskCenterScreen(
                    ...
                    onNavigateToGoals    = { navController.navigateSingle(AppRoute.LearningGoals.createRoute(1)) },
            ...
            composable(
                ...
                TimelineScreen(
                    characterId = if (characterId != null && characterId > 0) characterId else null,
                    onBack      = { navController.popBackStack() },
                )
            }
